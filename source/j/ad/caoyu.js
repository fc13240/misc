(function(){
	...
	if(scripts.length > 0){
		var caoyuScript = scripts[scripts.length - 1];
		W.js(caoyuScript.src.replace(/caoyu.js/,'caoyu-min.js'));//同步写入依赖文件
	}
	W(function(){
		document.applyWrite();
	});
...
(function(){
	...
	var inject = function (implant, callback) {
		...
		var injectHtml = function(parentNode, text) {
            var el = document.createElement('span'), filler = "<span>&nbsp;</span>", hookNode, scriptList, script, scriptHooks, noScripts, noEl;
