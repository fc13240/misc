...
(function(global){
	(function(hotZS){
		//热点指数配置
		hotZS.config = [{"type":"life","zs":[{"xc":"适宜|不宜"},{"ct":"炎热|热|冷|寒冷"},{"co":"舒适|暖|热|寒冷|十分寒冷"},{"pl":"优|较差|很差"},{"fs":"强|极强"},{"ys":"不带伞"}]},{"type":"trav","zs":[{"tr":"很适宜|适宜|较不宜"}]},{"type":"busi","zs":[{"tr":"很适宜|适宜|较不宜"},{"ct":"炎热|热|冷|寒冷"},{"co":"舒适|暖|热|寒冷|十分寒冷"},{"pl":"优|较差|很差"},{"uv":"强|极强"},{"ys":"不带伞"}]},{"type":"male","zs":[{"xc":"适宜|不宜"},{"ct":"炎热|热|冷|寒冷"},{"co":"舒适|暖|热|寒冷|十分寒冷"},{"ys":"不带伞"}]},{"type":"fema","zs":[{"ct":"炎热|热|冷|寒冷"},{"co":"舒适|暖|热|寒冷|十分寒冷"},{"fs":"强|极强"}]},{"type":"chil","zs":[{"ct":"炎热|热|冷|寒冷"},{"gz":"干燥|非常干燥"},{"co":"舒适|暖|热|寒冷|十分寒冷"},{"fs":"强|极强"}]},{"type":"elde","zs":[{"ct":"炎热|热|冷|寒冷"},{"co":"舒适|暖|热|寒冷|十分寒冷"},{"fs":"强|极强"}]}];
		//初始化
		hotZS.init = function(el,html,level,notice,mask){
			...
			hotZS.selTab("all");
			hotZS.zs=new W.ZS({"Container":el,"mask":mask,"height":hotZS.height});
			hotZS.setAnimate();
		};
		//选择分类
