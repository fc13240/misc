...
$("#time").html(timestr);
	...
	$(window).resize(function(){
		if($(this).width() <= 1130){
			...
			if($(".entrance").hasClass("open")){
				$(".icons").css({"marginRight":-($(window).scrollLeft()+$(window).width()/2),"top":($(window).scrollTop()+$(window).height()-($(".icons li").length*75)-330)});	
			}
			else{
				$(".icons").hide();
			}
			...
			$(".icons").css({"marginRight":"-565px","top":($(window).scrollTop()+$(window).height()-($(".icons li").length*75)-330)}).show();
		}
	...
	$(window).scroll(function(){
		if($(".entrance").hasClass("open")){
			...
			$(".icons").css({"marginRight":"-565px","top":($(window).scrollTop()+$(window).height()-($(".icons li").length*75)-330)});
		}
	})
