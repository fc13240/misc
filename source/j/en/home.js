		...
		function setWeather(){
			$.ajax({
				...
				success:function(type){
					...
					$li.find("img").attr('src','http://i.tq121.com.cn/i/en/home/weaIcon/'+fc_24_en.weatherinfo.img1.substring(0,fc_24_en.weatherinfo.img1.indexOf('.gif'))+'.png');
					tool_pngfix()
		...
		function weaConFun(){
			...
			$.ajax({
				...
				success:function(){
					...
					$li.children('img').attr('src','http://i.tq121.com.cn/i/en/home/'+fc_24_en.weatherinfo.img1.substring(0,fc_24_en.weatherinfo.img1.indexOf('.gif'))+'.jpg')			
